...
class EC2 {
	...
	private $EC2_INSTANCE_TYPES = array("t1.micro", "m1.small", "m1.medium", "m1.large", "m1.xlarge", "m2.xlarge", "m2.2xlarge", "m2.4xlarge", "c1.medium", "c1.xlarge", "cc1.4xlarge", "cc2.5xlarge");
	...
	private $INSTANCE_TYPE_MAPPING = array("stdODI" => "m1", "uODI" => "t1", "hiMemODI" => "m2", "hiCPUODI" => "c1", "clusterComputeI" => "cc1", "clusterGPUI" => "cc2", "hiIoODI" => "hi1", "stdResI" => "m1", "uResI" => "t1", "hiMemResI" => "m2", "hiCPUResI" => "c1", "clusterCompResI" => "cc1", "clusterGPUResI" => "cc2", "hiIoResI" => "hi1");
	...
	function _load_data($url) {
		print "Data from: " . $url . " = " . file_get_contents($url) . "\n";
		return json_decode(file_get_contents($url), TRUE);
	}

	function _get_ec2_reserved_instances_prices($filter_region = NULL, $filter_instance_type = NULL, $filter_os_type = NULL) {
	...
	function _get_ec2_ondemand_instances_prices($filter_region = NULL, $filter_instance_type = NULL, $filter_os_type = NULL) {
	...
	function get_ec2_data() {
		...
		$ret = array("reserved_instances" => $this -> _get_ec2_reserved_instances_prices(), "ondemand" => $this -> _get_ec2_ondemand_instances_prices());
